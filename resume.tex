  ...
  \cventry
    ...
    {August 2018 - June 2019}
    {
      \begin{cvitems}
        ...
        \item {Lead a team of three engineers in an Agile environment, with a test-driven approach}
...
%member of appdev grinnell
  \cventry
    {AppDev Club, Grinnell}
    {Senior Android Engineer}
    {Grinnell, IA}
    {January 2018 - May 2020}
    {
      \begin{cvitems}
        \item {Maintained the Grinnell-Directory Android app}	
        \item {Wrote tests using JUnit, Mockito and Espresso to support a large Java code base}
	    \item {Gained experience querying and storing data from public APIs in Android}
      \end{cvitems}
    }
...
% partyq
  \cventry
    ...
    {
      \begin{cvitems}
        \item{Distributed music queue mobile app that connects guests via bluetooth and wifi and plays music through the Spotify API}
        \item{Developed in Kotlin using latest design principles and best practices in Android, and released as open source}
