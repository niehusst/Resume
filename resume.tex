...
\begin{cventries}
  ...
  \cventry
    ...
    {
        \begin{cvitems}
            \item {Fixed critical accessibility issues in the Honey Android app for screen readers, keyboard navigation, and large font sizes}
            \item {Developed automated Espresso UI tests and added to CircleCI workflow}
  ...
  \cventry
    ...
    {January 2018 - May 2020}
    {
      \begin{cvitems}
        ...
        \item {Wrote tests using JUnit, Mockito and Espresso in Java}
      \end{cvitems}
    }
