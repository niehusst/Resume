...
% FakeBlock
  ...
  %       \item{Built in JavaScript, using AJAX to make calls to custom API to get predictions from machine learning model hosted on remote server}
...
\begin{cvskills}
  \cvskill
    ...
    {Python, Swift, Kotlin, JavaScript, Java, C/C++} 
