...
%frc programmer
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Wrote Java code to control our robot’s autonomous scoring mode using inputs from sensors.}
	\item {Enabled our robot to be manually controlled by programming it to respond to a range of controler inputs.}
      \end{cvitems}
    }
...
% HackUIowa Compliance Accomplice
	...
	{}
	{
	  \begin{cvitems}
	     ...
	     \item{Won “Best Commercial Potential” award and “Best use of Google Cloud” award from Major League Hacking.}
