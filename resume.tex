...
%MAP project
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Built C/C++ program with a partner to generate synthetic training data for a text recognizing neural network.}
        \item{Training with data generator improved neural network accuracy by 10\% over results when trained on industry standard data sets.}
...
%grammiegram android
  \cventry
    ...
    {
      \begin{cvitems}
        \item {Lead a team of three in an Agile environment to create the GrammieGram Android app using Java.}
...
% HackUIowa Compliance Accomplice
	...
	{
	  \begin{cvitems}
	     \item{Email middleware built with Python that prevents violation of government SEC law by investors.}
	     \item{Applied Natural Language Processing to predict fraud, deception, and unprofessionalism in emails.}
...
\begin{cvskills}
  ...
  \cvskill
    {Computer Science}
    {Computer Vision, Algorithms and Object Oriented Design}
...
\begin{cventries}
  \cventry
	...
	\item{Major GPA: 3.918/4.00 \quad Overall GPA: 3.667/4.00}
