...
%hytrust intern
  \cventry
    ...
    {
      \begin{cvitems}
	\item {Used Swagger/openAPI to make client-facing Django API self-documenting, greatly reducing documentation update turn-around time.}
	...
	%\item {Reduced Coverity high impact build errors by ___}
      \end{cvitems}
    }
...
%	    \item{Developed a TCP server using POSIX sockets to send encrypted data over.}
%	\end{cvitems}
%    }
